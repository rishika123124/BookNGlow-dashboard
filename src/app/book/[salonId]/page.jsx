...
const SALON_SERVICES = [
  ...
  { id: 'facial', name: 'Luxury Facial', price: 699 },
  { id: 'spa', name: 'Head Massage', price: 199 },
  { id: 'color', name: 'Hair Color', price: 899 },
];
...
export default function BookingPage() {
  ...
  useEffect(() => {
    const fetchBookings = async () => {
      ...
      try {
        ...
        const response = await fetch(`/api/bookings?salonId=${salonId}&date=${dateStr}`);
        const result = await response.json();
  ...
  const totalAmount = SALON_SERVICES
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-4 text-white/60">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span>{salon?.location || "Rajpur Road"}, Dehradun</span>
                  </div>
                  <div className="flex items-center gap-1.5">
                ...
                <div className="bg-[#1E1E1E] border border-white/10 rounded-[2.5rem] p-6 shadow-2xl">
                  <Calendar
                    ...
                    classNames={{
                      ...
                      day: "h-10 w-10 p-0 font-normal aria-selected:opacity-100 hover:bg-white/10 rounded-xl transition-all",
        ...
        <DialogContent className="bg-slate-900 border-white/10 text-white rounded-[2.5rem] p-8 md:p-10">
          <DialogHeader className="space-y-4">
            ...
            <DialogDescription className="text-white/60 text-center text-lg">
              Your request will be sent to <span className="text-[#A78BFA] font-bold">{salon?.salonName || "Salon Name"}</span>. We'll notify you once confirmed.
            </DialogDescription>
          </DialogHeader>
        ...
        <DialogContent className="bg-[#020617] border-purple-500/20 text-white rounded-[2.5rem] p-8 md:p-12 text-center max-w-md">
          <DialogHeader className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <DialogDescription className="text-white/60 text-lg">
                We've sent your request to <span className="text-white font-bold">{salon?.salonName}</span>.
              </DialogDescription>
            </div>
          </DialogHeader>
          ...
          <div className="mt-8 space-y-4">
            <p className="text-white/30 text-xs italic">
              Please check your dashboard for updates. You will receive an email once salon confirms.
            </p>
          </div>
