...
export default function AISalonSearchNew({ isOpen, onClose }) {
  ...
  // Dehradun locations - hardcoded for immediate display
  ...
  console.log('=== AI SALON SEARCH - REBUILT ===');
  console.log('Locations available:', dehradunLocations.length);
  console.log('Current selection:', location);
        ...
        <div className="p-6">
          ...
          {!location && !searchQuery && (
            <div className="text-center py-8">
              ...
              <p className="text-gray-600">
                Select a location and enter what you're looking for
              </p>
            </div>
          )}
        </div>
