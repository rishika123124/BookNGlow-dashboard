...
import { Sparkles, ShieldCheck, CreditCard, Mail, Phone } from 'lucide-react'
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-12 md:mb-20">
          <div className="space-y-4 md:space-y-6 text-center sm:text-left">
            ...
            <p className="font-body text-white/60 leading-relaxed text-sm md:text-base">
              Elevating beauty standards through technology and refined luxury in heart of Dehradun.
            </p>
          </div>
          ...
          <div className="space-y-4 md:space-y-6 text-center sm:text-left">
            <h4 className="font-headline text-lg md:text-xl">Contact</h4>
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                <Mail className="h-4 w-4 text-purple-400" />
                <span className="text-white/60 text-sm">bookNGlow@gmail.com</span>
              </div>
              <div className="flex items-center gap-2">
                <Phone className="h-4 w-4 text-blue-400" />
                <span className="text-white/60 text-sm">+91 78906 54321</span>
              </div>
            </div>
          </div>
        </div>
